...
namespace DigitalShop.Repo
{
    public class ProductRepository : IProductRepository
    {
        ...
        // GET ===================================
        // ALL -----------------------------------
        public async Task<PaginatedList<Product>> GetAllProductsAsync(ProductQueryParameter queryParams)
        {
            ...
            return new PaginatedList<Product>(products, count, queryParams.PageIndex, queryParams.PageSize);
        }
        // ONE -----------------------------------
